		...
		*/
		...
		do {
			...
			case 3:
				System.out.println("3.- Editar ");
				if (lista.isEmpty()) {
				    System.out.println("X La lista está vacía. No hay artículos para editar.");
				    break;
				}
				...
				while (true) {
				    ...
				    while (!scan.hasNextInt()) {
				        System.out.println("X Entrada inválida. Ingresa un número válido.");
				    ...
				    if (indice >= 0 && indice < lista.size()) {
				        ...
				        System.out.println("X Índice fuera de rango. Intenta de nuevo.");
				    }
				}
