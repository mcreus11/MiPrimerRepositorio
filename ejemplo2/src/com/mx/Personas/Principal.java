...
public class Principal {
	public static void main(String[] args) {
		Personas persona1 = new Personas("Carlos", "jimenez", 18, "hombre", 78, 1.78);
		...
		do {
			...
			try {
				...
				case 3:
					...
					imprimirDatos(imp);
					if (imp.lista.size() > 0) {
						System.out.println("Escriba el numero a editar");
				...
				case 4:
					...
					while (iter.hasNext()) {
					    ...
					    if (art.getNombre().equalsIgnoreCase(nombreBuscado1)) {
					        ...
					        System.out.print("¿Está seguro que desea eliminar el persona \"" + art.getNombre() + "\"? (s/n): ");
