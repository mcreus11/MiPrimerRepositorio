...
public class CryptoController {
    ...
    public EncryptResponse encrypt(@RequestBody EncryptRequest req) {
        String cipher = cryptoService.encrypt(req.getTexto(), req.getKey(), req.getIv());
        return new EncryptResponse(cipher);
    }

    @PostMapping("/decrypt")
    public DecryptResponse decrypt(@RequestBody EncryptRequest req) {
        String plain = cryptoService.decrypt(req.getTexto(), req.getKey(), req.getIv());
        return new DecryptResponse(plain);
    }
